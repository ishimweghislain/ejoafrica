...
import SchemeOfWorkModal from "@/components/SchemeModal"; // Assuming SchemeModal is the component
        ...
        <div className="space-y-10 animate-fade-up">
            <div className="flex flex-col md:flex-row md:items-center justify-between gap-6">
                <div className="space-y-1">
                    <h1 className="text-3xl font-black tracking-tight text-slate-900 uppercase tracking-tighter">Teaching Plans</h1>
                    <p className="text-slate-500 text-[10px] font-bold uppercase tracking-widest text-emerald-600">Plan your lessons and track curriculum progress.</p>
                </div>
                <button
                ...
                {loading ? (
                    ...
                    <div key={scheme.id} className="bg-white rounded-[3.5rem] border border-slate-100 shadow-sm overflow-hidden group hover:shadow-2xl transition-all relative">
                        <div className="p-10 space-y-8">
                            ...
                            <div className="grid grid-cols-3 gap-4 pt-4 border-t border-slate-50">
                                ...
                                <div className="space-y-1">
                                    <p className="text-[9px] font-black uppercase tracking-widest text-slate-300">Total Lessons</p>
                                    <p className="font-black text-slate-900 text-sm tracking-tight">{scheme._count.lessons} Lessons</p>
                                </div>
                                <div className="space-y-1">
                                    <p className="text-[9px] font-black uppercase tracking-widest text-slate-300">Progress</p>
                                    <p className="font-black text-emerald-600 text-sm tracking-tight">Active</p>
                                </div>
                            </div>
                    ...
                    <div className="col-span-full py-40 flex flex-col items-center gap-6 bg-slate-50/50 rounded-[4rem] border border-dashed border-slate-200">
                        ...
                        <div className="text-center space-y-2">
                            <p className="font-black text-slate-900 uppercase tracking-tighter text-xl">No Plans Yet</p>
                            <p className="text-[10px] font-black uppercase tracking-[0.2em] text-slate-400">Start by creating a teaching plan for your course.</p>
                        </div>
                    </div>
                )}
            </div>
