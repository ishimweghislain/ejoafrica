...
export default function SchemeDetailPage({ params }: { params: Promise<{ id: string }> }) {
    ...
    async function fetchScheme() {
        try {
            const res = await fetch(`/api/schemes-of-work/${id}`);
    ...
    if (loading) return (
        <div className="h-[70vh] flex flex-col items-center justify-center gap-4">
            ...
            <p className="text-[10px] font-black uppercase tracking-widest text-slate-400">Loading lesson plan...</p>
        </div>
    );
            ...
            <div className="flex flex-col md:flex-row md:items-start justify-between gap-8">
                <div className="space-y-4">
                    ...
                    <div className="space-y-1">
                        ...
                        <p className="text-[10px] font-black uppercase tracking-widest text-emerald-600 italic">Detailed Lesson Schedule</p>
                    </div>
                </div>
                <button
            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
                <div className="lg:col-span-2 space-y-6">
                    <div className="bg-white rounded-[3rem] border border-slate-100 shadow-sm overflow-hidden">
                        <div className="p-10 border-b border-slate-50 flex items-center justify-between">
                            <h3 className="text-xl font-black uppercase tracking-tighter">Lessons List</h3>
                            <span className="bg-slate-50 text-slate-400 px-4 py-1 rounded-full text-[9px] font-black uppercase tracking-widest border border-slate-100">
                                {scheme.lessons.length} Lessons Planned
                            </span>
                        </div>
                            ...
                            {scheme.lessons.length > 0 ? scheme.lessons.map((lesson, idx) => (
                                ...
                                <div className="py-32 flex flex-col items-center gap-6 text-center">
                                    ...
                                    <div className="space-y-2">
                                        ...
                                        <p className="text-[10px] font-black uppercase text-slate-400 tracking-widest">Click "Add New Lesson" to start planning.</p>
                                    </div>
                                </div>
                            )}
                        </div>
                ...
                <div className="lg:col-span-1 space-y-6">
                    <div className="bg-slate-900 rounded-[3rem] p-10 text-white space-y-8">
                        <div>
                            <p className="text-[10px] font-black uppercase tracking-[0.2em] text-emerald-500 mb-2">Class Information</p>
                        ...
                        <div className="space-y-6">
                            ...
                            <div className="space-y-1">
                                <p className="text-[9px] font-black uppercase tracking-widest text-slate-500">Academic Term</p>
