        ...
        <div className="space-y-10 animate-fade-up">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                {filteredClasses.length > 0 ? (
                            ...
                            {selectedClassId === cls.id && (
                                <div className="bg-slate-50/50 border-t border-slate-100 p-8 space-y-4 animate-fade-in max-h-[400px] overflow-y-auto">
                                    ...
                                    {(!cls.users || cls.users.length === 0) && (
                                        <div className="py-10 text-center text-[10px] font-black uppercase tracking-widest text-slate-300">No students in this domain.</div>
                                    )}
                                </div>
                            )}
                        </div>
                    ...
                    <div className="col-span-full py-40 bg-slate-50 rounded-[4rem] border border-dashed border-slate-200 flex flex-col items-center gap-6">
                        <ShieldAlert className="w-16 h-16 text-slate-200" />
                        <div className="text-center space-y-2">
                            <h3 className="text-xl font-black text-slate-900 uppercase tracking-tighter">Conduct Matrix Empty</h3>
                            <p className="text-[10px] font-black uppercase text-slate-400 tracking-widest">No disciplinary nodes detected in current search protocol.</p>
                        </div>
                    </div>
                )}
            </div>
