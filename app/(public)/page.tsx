    ...
    return (
        <div className="flex flex-col pb-32 overflow-x-hidden bg-white">
            ...
            <section className="relative h-[85vh] flex items-center overflow-hidden">
                ...
                <div className="relative z-10 max-w-7xl mx-auto px-8 w-full">
                    ...
                    >
                        ...
                        >
                            The most advanced administrative ecosystem developed specifically for high-performance African educational institutions.
                        </motion.p>
            ...
            <section className="max-w-7xl mx-auto px-8 w-full py-24">
                ...
                >
                    <h2 className="text-[9px] font-black uppercase tracking-[0.5em] text-emerald-600 italic">Advanced Architecture</h2>
                    <h3 className="text-3xl font-black tracking-tighter text-slate-900 uppercase italic">Centralized Digital Intelligence</h3>
                    <p className="text-xs text-slate-400 font-bold uppercase tracking-widest leading-relaxed">Integrated modules for complete institutional control.</p>
                </motion.div>
            ...
            <section className="max-w-5xl mx-auto px-8 w-full">
                ...
                >
                    ...
                    <p className="text-[10px] font-black uppercase tracking-[0.3em] mb-10 opacity-70">Initialize your institution's digital transformation protocol.</p>
                    <Link href="/register" className="inline-flex items-center gap-4 bg-slate-900 text-white px-12 py-5 rounded-xl font-black uppercase text-xs tracking-[0.3em] hover:bg-black transition-all hover:scale-105 shadow-2xl italic group">
                        Launch System <ArrowRight className="w-4 h-4 group-hover:translate-x-1 transition-all" />
                    </Link>
                </motion.div>
            </section>
        </div>
